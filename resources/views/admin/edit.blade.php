...
@section('content')
<form action="{{route('list.update',$data->id)}}" method="PUT">
    @csrf
            ...
            <div class="row">
                ...
                <div class="col align-self-end">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="rate_eur" name="rate_eur" value="{{$data->rate_eur}}">
                        </div>
                    </div>
                    <div class=" form-group row">
                        <label for="date_paid" class="col col-form-label">Date Paid</label>
                        <div class="col-sm-10">
                            <input type="date" class="form-control" id="date_paid" name="date_paid" value="{{$data->date_paid}}">
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(document).ready(function() {
        ...
        $('#addBtn1').on('click', function() {
            ...
            $('#tbody1').append(`<tr id="R${++rowIdx}">
             ...
             <input type="text" id="nama_transaksi_kategori"></input>
             </td>
              <td class="row-index text-center1">
             <input type="text" id="value_idr"></input>
             </td>
              </tr>`);
        });
